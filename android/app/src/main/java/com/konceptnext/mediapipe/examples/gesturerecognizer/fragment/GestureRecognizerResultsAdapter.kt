...
import com.konceptnext.mediapipe.examples.gesturerecognizer.databinding.ItemGestureRecognizerResultBinding
...
class GestureRecognizerResultsAdapter :
    ...
    var currentSignLabel: String? = null
    companion object {
...
//            Log.e("sortedCategories", sortedCategories.toString())
//            Log.e("adapterCategories", adapterCategories.toString())
